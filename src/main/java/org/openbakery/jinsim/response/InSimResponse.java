...
abstract public class InSimResponse {
	...
	/**
	 * @param buffer A ByteBuffer that will be turned into a specific type of response. This ByteBuffer usually is the ByteBuffer contained within the UDP packet sent to the client. A notable exception to
