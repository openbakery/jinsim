...
public enum Track {
	...
	WESTHILL_NATIONAL("500", "Westhill National", "WE1", 3),
	WESTHILL_NATIONAL_REVERSE("501", "Westhill National Reverse", "WE1R", 3),
	WESTHILL_NATIONAL_OPEN("502", "Westhill National Open", "WE1X", 0),
	WESTHILL_NATIONAL_OPEN_REVERSE("503", "Westhill National Open Reverse", "WE1Y", 0),

	WESTHILL_INTERNATIONAL("510", "Westhill International", "WE1", 3),
	WESTHILL_INTERNATIONAL_REVERSE("511", "Westhill International Reverse", "WE1R", 3),
	WESTHILL_INTERNATIONAL_OPEN("512", "Westhill International Open", "WE1X", 0),
	WESTHILL_INTERNATIONAL_OPEN_REVERSE("513", "Westhill International Open Reverse", "WE1Y", 0),

	WESTHILL_CAR_PARK("520", "Westhill Car Park", "WE2", 0),

	WESTHILL_KARTING("530", "Westhill Karting", "WE3", 0),
	WESTHILL_KARTING_REVERSE("531", "Westhill Karting", "WE3R", 0),
	WESTHILL_KARTING_OPEN("532", "Westhill Karting Open", "WE3X", 0),
	WESTHILL_KARTING_OPEN_REVERSE("533", "Westhill Karting Open Reverse", "WE3Y", 0),

	WESTHILL_KARTING_NATIONAL("540", "Westhill National Karting", "WE4", 0),
	WESTHILL_KARTING_NATIONAL_REVERSE("541", "Westhill National Karting", "WE4R", 0),
	WESTHILL_KARTING_NATIONAL_OPEN("542", "Westhill National Karting Open", "WE4X", 0),
	WESTHILL_KARTING_NATIONAL_OPEN_REVERSE("543", "Westhill National Karting Open Reverse", "WE4Y", 0),
