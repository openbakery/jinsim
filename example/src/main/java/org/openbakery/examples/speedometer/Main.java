...
public class Main {
    ...
    /**
     * Create a JFrame and put a {@link SpeedometerPanel} in it. Most of the work is done in {@link SpeedometerPanel}.
     */
    public void run() {
        try {
            ...
            SpeedometerPanel jinsimPanel = new SpeedometerPanel(hostname, port, adminPassword);
